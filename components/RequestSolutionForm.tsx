  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-3xl mx-auto space-y-16" noValidate>
      ...
      <div>
        ...
        {/* The token will be appended in onSubmit, no need for hidden input */}

        {status === "error" && (
          <div className="flex items-start gap-2.5 text-sm text-red-700 bg-red-50 border border-red-200 rounded-sm px-4 py-3 mt-6">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-[#C08A3E] hover:bg-[#a8752f] disabled:opacity-60 text-white font-semibold px-8 py-4 rounded-sm transition-colors mt-6"
        >
