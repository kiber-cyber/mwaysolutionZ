  ...
  return (
    <div className="min-h-screen bg-[#F6F5F1] text-[#1A1D22] font-sans selection:bg-[#C08A3E] selection:text-white">
      ...
      <section className="relative overflow-hidden bg-[#0E1B2B] text-white">
        ...
        <div className="reg-mark text-[#3E6B8A]/60 top-8 left-8" />
        <div className="reg-mark text-[#3E6B8A]/60 bottom-8 right-8" />

        <div className="relative max-w-7xl mx-auto px-6 lg:px-10 pt-24 pb-28 lg:pt-32 lg:pb-36">
          <div className="inline-flex items-center gap-2 text-xs font-medium tracking-widest text-[#3E6B8A] border border-[#3E6B8A]/40 rounded-sm px-3 py-1.5 mb-8">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#C08A3E] hover:bg-[#a8752f] text-white font-semibold px-6 py-3.5 rounded-sm transition-colors"
            >
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-24">
        <div className="flex items-end justify-between mb-12 flex-wrap gap-4">
          <div>
            <div className="text-xs font-medium tracking-widest text-[#3E6B8A] mb-3">CAPABILITIES</div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-[#1A1D22]/10 border border-[#1A1D22]/10">
          {CAPABILITIES.map(({ icon: Icon, title, desc, ref }) => (
            <div key={title} className="bg-[#F6F5F1] p-8 hover:bg-white transition-colors">
              <div className="flex items-center justify-between mb-6">
                <Icon size={26} strokeWidth={1.5} className="text-[#3E6B8A]" />
                <span className="text-[11px] tracking-widest text-[#1A1D22]/35">{ref}</span>
              </div>
      ...
      <section className="bg-white border-y border-[#1A1D22]/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-24">
          <div className="text-xs font-medium tracking-widest text-[#3E6B8A] mb-3">SOLUTIONS</div>
          <h2 className="font-display text-3xl lg:text-4xl font-semibold max-w-2xl mb-4">
            Solutions That Move Projects Forward
          </h2>
          <p className="text-[#1A1D22]/65 max-w-2xl mb-14 leading-relaxed">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="border border-[#1A1D22]/12 p-10">
              <Building2 className="text-[#3E6B8A] mb-6" size={28} strokeWidth={1.5} />
              <h3 className="font-display text-xl font-semibold mb-3">Equipment & Supply</h3>
              <ul className="text-sm text-[#1A1D22]/65 space-y-2 mb-8 leading-relaxed">
              ...
              <a href="/solutions" className="inline-flex items-center gap-2 text-sm font-semibold text-[#0E1B2B]">
                View Solutions <ArrowRight size={14} />
              </a>
            </div>

            <div className="bg-[#0E1B2B] text-white p-10">
              <ShieldCheck className="text-[#C08A3E] mb-6" size={28} strokeWidth={1.5} />
      ...
      {/* FEATURED PRODUCTS */}
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-24">
        <div className="text-xs font-medium tracking-widest text-[#3E6B8A] mb-3">CATALOG</div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {PRODUCTS.map((p) => (
            <div key={p.name} className="group border border-[#1A1D22]/12 bg-white flex flex-col">
              ...
              <div className="p-5 flex flex-col flex-1">
                <span className="text-[11px] tracking-widest text-[#3E6B8A] mb-2">{p.category.toUpperCase()}</span>
                <h3 className="font-display text-base font-semibold mb-2">{p.name}</h3>
                <p className="text-sm text-[#1A1D22]/60 leading-relaxed mb-5 flex-1">{p.desc}</p>
                <div className="flex flex-col gap-2">
                  <a href="#" className="text-xs font-semibold border border-[#1A1D22]/20 text-center py-2.5 hover:border-[#1A1D22]/40 transition-colors">
                    View Details
                  </a>
                  <a href="#" className="text-xs font-semibold bg-[#C08A3E] hover:bg-[#a8752f] text-white text-center py-2.5 transition-colors">
                    Request Information
                  </a>
                </div>
              </div>
        ...
        <div className="mt-12 text-center">
          <a href="/products" className="inline-flex items-center gap-2 text-sm font-semibold text-[#0E1B2B]">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-28 text-center">
        <div className="text-xs font-medium tracking-widest text-[#3E6B8A] mb-4">GET STARTED</div>
        <h2 className="font-display text-3xl lg:text-5xl font-semibold mb-6 max-w-2xl mx-auto">
          Have a Requirement?
        </h2>
        <p className="text-[#1A1D22]/65 max-w-xl mx-auto mb-10 leading-relaxed">
